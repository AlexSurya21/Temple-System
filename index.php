            ...
            <div class="nav-links">
                ...
                <div class="login-dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="user/user_login.php">👤 Devotee Login</a>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="user/user_register.php" class="btn btn-primary">Get Started</a>
    ...
    <section class="user-types" id="services">
        ...
        <div class="cards-container">
            ...
            <div class="user-card">
                ...
                <a href="user/user_login.php" class="btn btn-primary">Devotee Login</a>
            </div>
